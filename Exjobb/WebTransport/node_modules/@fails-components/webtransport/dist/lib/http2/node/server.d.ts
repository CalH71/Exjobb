...
export class Http2WebTransportServer {
     ...
     */
    finishSessionRequest({ header, userData, session: stream, status, protocol, head, path, transportPrivate, selectedProtocol }: import('../../types.js').NativeFinishSessionRequest): void;
}
